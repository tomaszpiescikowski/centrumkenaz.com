    ...
    <details className="page-subcard text-xs" data-no-hover="true">
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((code) => (
          <div
            key={code}
            className="flex flex-col gap-1.5 rounded-xl border border-navy/10 dark:border-cream/10 bg-[rgba(255,253,245,0.72)] dark:bg-[rgba(15,23,74,0.68)] p-2.5 overflow-hidden"
          >
