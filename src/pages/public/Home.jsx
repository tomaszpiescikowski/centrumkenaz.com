  ...
  return (
    <div className="page-shell flex flex-col items-center [min-height:calc(100svh_-_env(safe-area-inset-bottom,0px)_-_5.25rem)] sm:min-h-[calc(100vh-4rem)] sm:pb-12">
      ...
      <div className="w-full max-w-xs flex-none space-y-4 px-8 sm:max-w-sm">
        <Link
          to="/login"
          className="block w-full rounded-full bg-navy px-6 py-3 text-center text-sm font-black text-cream shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl dark:bg-cream dark:text-navy sm:px-8 sm:py-4 sm:text-lg"
        >
          {t('auth.openLogin')}
        </Link>
        <Link
          to="/about"
          className="group flex w-full items-center justify-center gap-2 rounded-full bg-navy px-6 py-3 text-sm font-black text-cream shadow-lg transition hover:-translate-y-0.5 hover:shadow-xl dark:bg-cream dark:text-navy sm:px-8 sm:py-4 sm:text-lg"
        >
        ...
        <Link
          to="/support"
          className="group flex w-full items-center justify-center gap-2 rounded-full border-2 border-navy px-6 py-3 text-sm font-black text-navy shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-cream dark:text-cream sm:px-8 sm:py-4 sm:text-lg"
        >
