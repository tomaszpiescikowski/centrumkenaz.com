...
function ParticipantsTable({
  ...
  if (loading) {
    return (
      <div className={`rounded-2xl border border-navy/10 bg-[rgba(255,251,235,0.82)] dark:border-cream/15 dark:bg-[rgba(15,23,74,0.68)] animate-pulse ${compact ? 'p-5' : 'p-8'} ${className}`}>
  ...
  return (
    <div className={`flex h-full min-h-0 flex-col rounded-2xl border border-navy/10 bg-[rgba(255,251,235,0.82)] dark:border-cream/15 dark:bg-[rgba(15,23,74,0.68)] ${compact ? 'p-5' : 'p-8'} ${className}`}>
